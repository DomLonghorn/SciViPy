...
CleanedOutputs = []
FileID = []
File = open("Testing/jorek_times.txt", "r")
...
count = 0  # Incorporates significant figures (see for loop below)
...
# print("CleanedOutputs: ", CleanedOutputs)
...
with open(r"Testing/TestText.txt", "w") as fp:
    for item in FileID:
